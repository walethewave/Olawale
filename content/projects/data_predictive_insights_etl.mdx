...
description: This project develops a data analytics and reporting application for analyzing the Powerlifting Database . It uses ETL processes to transform and load data into a PostgreSQL database. 
date: 2024-06-01
